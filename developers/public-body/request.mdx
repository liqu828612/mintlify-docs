...
| transType  | string | 交易类型【PAY、CREDIT_CARD、3D_PREAUTH_VOIDS、3D_PREAUTH_COMPLETION、<br></br> REFUND、VOIDS、QUERY、  TRANSFER、DOWNLOAD、REGISTRATION、<br></br> FILEUPLOAD、INQUIRYREGISTRATIONSTATUS、AUTHORIZE】 | PAY              | 必须   |
